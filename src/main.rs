...
impl Obj {
    ...
    fn check_needs_rebuild(&mut self, force_rebuild: bool, target: &str) -> bool {
        ...
        let obj_path: ByteString = format!("obj/{}/lib{}.rlib", target, self.crate_name);
        ...
        let dep_path: ByteString = format!("obj/{}/{}.d", target, self.crate_name);
