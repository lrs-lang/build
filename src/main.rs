...
impl Obj {
    ...
    fn check_needs_rebuild(&mut self, force_rebuild: bool, target: &str) -> bool {
        ...
        let obj_path: ByteString = format!("obj/{}/lib{}.rlib", target, full_name);
        ...
        let dep_path: ByteString = format!("obj/{}/{}.d", target, full_name);
...
fn main() {
    ...
    target.lock().check_needs_rebuild(args.rebuild, args.target);
